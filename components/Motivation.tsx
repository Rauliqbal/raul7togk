        ...
        <div className="col-span-2">
          <Transition>
            <p className="text-base md:text-3xl tracking-wide leading-relaxed    font-inter-thin">
              ...
              tell a story, <i>&quot;show off a brand&quot;</i>, or change
          ...
          <Transition>
            <p className="text-base md:text-3xl tracking-wide leading-relaxed  mt-8  font-inter-thin">
              ...
              <i>&quot;digital experiences&quot;</i> that inform, entertain, and
              inspire. Every day is different - one day you may be sketching
              site layouts on paper, the next you&apos;re coding up responsive
              page templates. Web design keeps you on your toes!
            </p>
          </Transition>
